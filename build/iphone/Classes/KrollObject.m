 ...
 * Copyright (c) 2009-2011 by fanapp, Inc. All Rights Reserved.
...
//@interface fanappObject : NSObject
//@end

@interface fanappObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[fanappObject class]])
		{
			for (NSString *key in [[(fanappObject*)o modules] allKeys])
			{
