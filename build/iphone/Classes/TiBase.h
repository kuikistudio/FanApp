...
// in simulator we redefine to format for fanapp Developer console
...
{\
	NSString * exceptionName = [@"org.fanapp." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.fanapp";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIfanappNativeItemNone = -1, 
	UIfanappNativeItemSpinner = -2,
	UIfanappNativeItemProgressBar = -3,
	
	UIfanappNativeItemSlider = -4,
	UIfanappNativeItemSwitch = -5,
	UIfanappNativeItemMultiButton = -6,
	UIfanappNativeItemSegmented = -7,
	
	UIfanappNativeItemTextView = -8,
	UIfanappNativeItemTextField = -9,
	UIfanappNativeItemSearchBar = -10,
	
	UIfanappNativeItemPicker = -11,
	UIfanappNativeItemDatePicker = -12,
	
	UIfanappNativeItemInfoLight = -13,
	UIfanappNativeItemInfoDark = -14,
	
	UIfanappNativeItemDisclosure = -15,
	
	UIfanappNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all fanapp instances of
